...
class TwoNN(nn.Module):
    def __init__(self, name, in_features, num_hiddens, num_classes):
        ...
        self.fc1 = nn.Linear(in_features=in_features, out_features=num_hiddens)
        self.fc2 = nn.Linear(in_features=num_hiddens, out_features=num_hiddens)
        self.fc3 = nn.Linear(in_features=num_hiddens, out_features=num_classes)
